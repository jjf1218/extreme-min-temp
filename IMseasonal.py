...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Indian Mills Max Minimum Temperatures", fontsize=14)
plt.savefig("IMseasonal_max_min.png", bbox_inches='tight')
#plt.show()
...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Indian Mills Min Minimum Temperatures", fontsize=14)
plt.savefig("IMseasonal_min_min.png", bbox_inches='tight')
#plt.show()
