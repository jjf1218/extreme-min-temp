...
p90 = np.percentile(daily_precip_array[daily_precip_array != 0],90)
p95 = np.percentile(daily_precip_array[daily_precip_array != 0],95)
p99 = np.percentile(daily_precip_array[daily_precip_array != 0],99)
#print p90, p95, p99
...
with open('nonzero_percentile_data.csv', 'wb') as f: #change station!
    writer = csv.writer(f)
