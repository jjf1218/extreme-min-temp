...
station = ["SF_max_min.txt", "SF_min_min.txt"]
...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Seabrook Farms Max Minimum Temperatures", fontsize=14)
plt.savefig("SFseasonal_max_min.png", bbox_inches='tight')
#plt.show()
...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Seabrook Farms Min Minimum Temperatures", fontsize=14)
plt.savefig("SFseasonal_min_min.png", bbox_inches='tight')
#plt.show()
