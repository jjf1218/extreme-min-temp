...
station = ["CR_max_min.txt", "CR_min_min.txt"]
...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Charlotteburg Reservoir Max Minimum Temperatures", fontsize=14)
plt.savefig("CRseasonal_max_min.png", bbox_inches='tight')
#plt.show()
...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Charlotteburg Reservoir Min Minimum Temperatures", fontsize=14)
plt.savefig("CRseasonal_min_min.png", bbox_inches='tight')
#plt.show()
