...
station = ["NB_max_min.txt", "NB_min_min.txt"]
...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("New Brunswick Max Minimum Temperatures", fontsize=14)
plt.savefig("NBseasonal_max_min.png", bbox_inches='tight')
#plt.show()
...
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("New Brunswick Min Minimum Temperatures", fontsize=14)
plt.savefig("NBseasonal_min_min.png", bbox_inches='tight')
#plt.show()
