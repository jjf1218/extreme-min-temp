...
station = ["CM_max_min.txt", "CM_min_min.txt"]
...
plt.title("Spring Max Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
# top right, summer
plt.subplot(2,2,2)
plt.plot(years1, summer_max, 'r',linewidth=2)
plt.title("Summer Max Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
# bottom left, fall
plt.subplot(2,2,3)
plt.plot(years2, fall_max, 'r',linewidth=2)
plt.title("Fall Max Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
# bottom right, winter
plt.subplot(2,2,4)
plt.plot(years2, winter_max[:-1], 'r',linewidth=2)
plt.title("Winter Max Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Cape May Max Minimum Temperatures", fontsize=14)
plt.savefig("CMseasonal_max_min.png", bbox_inches='tight')
#plt.show()
...
for i in range(len(spring_min)):
    if spring_min[i] > 130.0:
        spring_min[i] = np.NaN
...
for i in range(len(summer_min)):
    if summer_min[i] > 130.0:
        summer_min[i] = np.NaN
...
plt.title("Spring Min Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
# top right, summer
plt.subplot(2,2,2)
plt.plot(years1, summer_min, 'b',linewidth=2)
plt.title("Summer Min Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
# bottom left, fall
plt.subplot(2,2,3)
plt.plot(years2, fall_min, 'b',linewidth=2)
plt.title("Fall Min Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
# bottom right, winter
plt.subplot(2,2,4)
plt.plot(years2, winter_min[:-1], 'b',linewidth=2)
plt.title("Winter Min Minimum Temperatures")
plt.xlabel("Year")
plt.ylabel("Temperature (F)")
plt.suptitle("Cape May Min Minimum Temperatures", fontsize=14)
plt.savefig("CMseasonal_min_min.png", bbox_inches='tight')
#plt.show()
